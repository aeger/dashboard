...
export async function PUT(req: Request) {
  ...
  try {
    ...
    const allowed = ['title', 'description', 'status', 'priority', 'target_date', 'progress', 'notes', 'tags', 'sort_order', 'completed_at', 'implementation_prompt', 'auto_queue', 'last_queued_at', 'parent_id']
